package me.gimmesomepeace.zzzcompanion.data.shared.storage
...
class InMemoryListStorage<ID, E>(
    ...
    override suspend fun insert(entity: E): InsertResult =
        mutex.withLock {
    ...
    override suspend fun update(entity: E): UpdateResult =
        mutex.withLock {
            val entityId = idSelector(entity)
    ...
    override suspend fun delete(id: ID): DeleteResult =
        mutex.withLock {
