package me.gimmesomepeace.zzzcompanion.data.memory.attribute
...
import me.gimmesomepeace.zzzcompanion.core.attribute.repository.AttributeWriterRepository
...
class InMemoryAttributeRepository(
    ...
    override suspend fun get(id: AttributeId): Attribute =
        storage.get(id) ?: throw EntityNotFoundException(Attribute::class, id.value)

    override suspend fun find(id: AttributeId): Attribute? = storage.get(id)
